...
class MyGreedyAgent(Agent):
    def getAction(self,state):
        ...
        print "food", food_location
        print "x", range(len(food_location))
        # print len(walls_location)
        # print len(corners_location)
        print food_location[0][0]
        print food_location[0][1]
        width = corners_location[1][0] - corners_location[0][0] +1
        print width
        height = corners_location[2][1] - corners_location[0][1] +1
        print height
        Matrix= [[0 for j in range(width)] for i in range(height)]
        print Matrix

        for i in range(len(food_location)):
            foody = food_location[i]
            print "f", foody
            m = foody[0]
            print "m", m
            n = foody[1]
        ...
        # for i in xrange(0,len(walls_location)):
        #     m = food_location[i][0]
        #     n = food_location[i][1]
        #     Matrix[n][m] = 0
